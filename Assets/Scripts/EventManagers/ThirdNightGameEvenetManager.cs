...
public class ThirdNightGameEvenetManager : GameEventManager
{
    ...
    private IEnumerator FirstCutSceneCoroutine()
    {
        ...
        ChatManager.chatManager.OpenChat(50, EndFirstCutScene);
    }
    ...
    private IEnumerator MoveToNextScene()
    {
        ...
        GameManager.gameManager.ShowTextOn("3일째 어딘가", 3);
        GameManager.gameManager.sceneNumber = 8;
        GameManager.gameManager.MoveScene("ThirdPuzzleScene", true);
    }
