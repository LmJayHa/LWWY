...
public class SixthNightGameEventManager : GameEventManager
{
    ...
    private IEnumerator FirstCutSceneCoroutine()
    {
        ...
        ChatManager.chatManager.OpenChat(81, EndFirstCutScene);
    }
    ...
    private IEnumerator MoveToNextScene()
    {
        ...
        GameManager.gameManager.ShowTextOn("6일째 어딘가", 3);
        GameManager.gameManager.sceneNumber = 17;
        GameManager.gameManager.MoveScene("SixthPuzzleScene", true);
    }
